        ...
        <>
            ...
            >
                <SwiperSlide style={{ backgroundImage: `url(${img1})` }} className="py-20 px-6 md:p-48 bg-cover bg-center text-center">
                    ...
                    <h1 className="text-white font-bold text-5xl md:text-7xl">Pursue <span className="inline-block mini-header-color font-light italic">your</span> passion. <br /> Create your <span className="inline-block mini-header-color font-light italic">life</span></h1>
                    <Link to='/all-dolls'>
